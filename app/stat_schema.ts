...
export const STAT_SCHEMA: Category[] = [
  {
    ...
    fields: [
      ...
      {
        key: "super_crit_chance",
        label: "Super Crit Chance",
        type: "number",
        unit: "pct",
        formula: { base: 0, increment: 0.2, maxLevel: 100 },
      },
      {
        ...
        type: "number",
        unit: "mult",
        formula: { base: 1.2, increment: 0.1, maxLevel: 120 },
    ...
    fields: [
      {
        ...
        label: "Health",
        type: "int",
        enhancement: enh("health_enh", "Health ×", { base: 1, increment: 0.01, maxLevel: 400 }),
      },
      {
        key: "health_regen",
        label: "Health Regen",
      ...
      { key: "lifesteal", label: "Lifesteal", type: "number", unit: "pct" },
      {
        ...
        type: "number",
        unit: "pct",
        formula: { base: 0, increment: 1, maxLevel: 80 },
      },
      {
        key: "knockback_force",
        label: "Knockback Force",
        type: "int",
        formula: { base: 0.4, increment: 0.142, maxLevel: 40 },
      },
      {
        key: "orb_speed",
        label: "Orb Speed",
        type: "int",
        formula: { base: 0.4, increment: 0.15, maxLevel: 38 },
      },
      {
        key: "orbs",
        label: "Orbs",
        type: "int",
        enhancement: enh("orb_size_enh", "Orb Size ×", { base: 1, increment: 0.01, maxLevel: 200 }),
      },
      ...
      { key: "land_mine_radius", label: "Land Mine Radius", type: "int" },
      {
        ...
        type: "number",
        unit: "pct",
        formula: { base: 0, increment: 0.4, maxLevel: 75 },
      },
      {
        key: "wall_health",
        label: "Wall Health",
    ...
    fields: [
      {
        ...
        formula: { base: 1, increment: 0.01, maxLevel: 149 },
      ...
      { key: "coins_wave", label: "Coins / Wave", type: "int" },
      {
        ...
        type: "number",
        unit: "pct",
        formula: { base: 0, increment: 0.06, maxLevel: 99 },
      },
      {
        key: "recovery_amount",
